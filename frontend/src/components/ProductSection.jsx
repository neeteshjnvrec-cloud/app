      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center gap-4 mb-8">
            ...
            <h2 className="text-3xl font-bold text-[#2B5F8D]">Our Brand</h2>
            <div className="h-px bg-gray-300 w-32"></div>
          </div>
          <div className="mb-8">
            ...
            <div className="text-sm text-gray-500 mt-1">Smart Healing</div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-[#E8F5E9] to-[#C8E6C9] rounded-3xl p-12 relative overflow-hidden">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <Button className="bg-[#2B5F8D] hover:bg-[#1e4a6b] text-white rounded-full px-8 py-6 text-base">
                Learn more →
              </Button>
            </div>
